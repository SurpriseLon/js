...
var Sentry = function (n) {
    ...
    var e = function () {
        return (e = Object.assign || function (n) {
            for (var t, r = 1, e = arguments.length; r < e; r++)
                for (var i in t = arguments[r]) Object.prototype.hasOwnProperty.call(t, i) && (n[i] = t[
                    i]);
            return n
    ...
    ! function (n) {
    ...
    }(u || (u = {})), (c = n.Severity || (n.Severity = {})).Fatal = "fatal", c.Error = "error", c.Warning =
        "warning", c.Log = "log", c.Info = "info", c.Debug = "debug", c.Critical = "critical",
        function (n) {
        ...
        }(n.Severity || (n.Severity = {})), (s = n.Status || (n.Status = {})).Unknown = "unknown", s.Skipped =
        "skipped", s.Success = "success", s.RateLimit = "rate_limit", s.Invalid = "invalid", s.Failed = "failed",
        function (n) {
            n.fromHttpCode = function (t) {
                return t >= 200 && t < 300 ? n.Success : 429 === t ? n.RateLimit : t >= 400 && t < 500 ? n.Invalid :
                    t >= 500 ? n.Failed : n.Unknown
            }
        }(n.Status || (n.Status = {}));
    ...
    function k(n, t, r) {
        n.exception = n.exception || {}, n.exception.values = n.exception.values || [], n.exception.values[0] = n.exception
            .values[0] || {}, n.exception.values[0].value = n.exception.values[0].value || t || "", n.exception.values[
                0].type = n.exception.values[0].type || r || "Error"
    }

    function T(n, t) {
        void 0 === t && (t = {});
        try {
            n.exception.values[0].mechanism = n.exception.values[0].mechanism || {}, Object.keys(t).forEach(
                function (r) {
    ...
    function D(n) {
        try {
            for (var t = n, r = [], e = 0, i = 0, o = " > ".length, u = void 0; t && e++ < 5 && !("html" === (u = I(
                    t)) || e > 1 && i + r.length * o + u.length >= 80);) r.push(u), i += u.length, t = t.parentNode;
    ...
    function H(n, t) {
        return r = t, "[object RegExp]" === Object.prototype.toString.call(r) ? t.test(n) : "string" == typeof t &&
            -1 !== n.indexOf(t);
        var r
    }
    ...
    function W(n) {
        ...
        if (m(n)) {
            ...
            for (var e in "undefined" != typeof CustomEvent && n instanceof CustomEvent && (i.detail = n.detail), n)
    ...
    function X(n, t) {
        return "domain" === t && "object" == typeof n && n.u ? "[Domain]" : "domainEmitter" === t ?
            "[DomainEmitter]" : "undefined" != typeof global && n === global ? "[Global]" : "undefined" != typeof window &&
            n === window ? "[Window]" : "undefined" != typeof document && n === document ? "[Document]" : y(r = n) &&
            "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r ? "[SyntheticEvent]" : "number" ==
            typeof n && n != n ? "[NaN]" : void 0 === n ? "[undefined]" : "function" == typeof n ? "[Function: " +
            (n.name || "<unknown-function-name>") + "]" : n;
        var r
    }
    ...
    var Z = /^[ \t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \t]*$/,
        nn = function () {
            function n(n, t, r, e) {
                void 0 === n && (n = j()), void 0 === t && (t = j().substring(16)), this.O = n, this.k = t, this.T =
                    r, this.R = e
            }
        ...
        tn = function () {
            ...
            return n.prototype.addScopeListener = function (n) {
                ...
                var r = new n;
                return t && (r.N = o(t.N), r.U = e({}, t.U), r.A = e({}, t.A), r.L = e({}, t.L), r.M = t.M, r.P =
                    t.P, r.B = t.B, r.W = t.W, r.H = t.H, r.C = o(t.C)), r
            }, n.prototype.clear = function () {
                return this.N = [], this.U = {}, this.A = {}, this.M = {}, this.L = {}, this.P = void 0, this.W =
                    void 0, this.H = void 0, this.B = void 0, this.q(), this
            }, n.prototype.addBreadcrumb = function (n, t) {
                var r = (new Date).getTime() / 1e3,
                    i = e({
                        timestamp: r
                    }, n);
                return this.N = void 0 !== t && t >= 0 ? o(this.N, [J(i)]).slice(-t) : o(this.N, [J(i)]), this.q(),
                    this
                ...
                n.fingerprint = n.fingerprint ? Array.isArray(n.fingerprint) ? n.fingerprint : [n.fingerprint] :
                    [], this.H && (n.fingerprint = n.fingerprint.concat(this.H)), n.fingerprint && !n.fingerprint
                    .length && delete n.fingerprint
            }, n.prototype.applyToEvent = function (n, t) {
                return this.A && Object.keys(this.A).length && (n.extra = e({}, this.A, n.extra)), this.U &&
                    Object.keys(this.U).length && (n.tags = e({}, this.U, n.tags)), this.M && Object.keys(this.M)
                    .length && (n.user = e({}, this.M, n.user)), this.L && Object.keys(this.L).length && (n.contexts =
                        e({}, this.L, n.contexts)), this.P && (n.level = this.P), this.W && (n.transaction =
                        this.W), this.B && (n.contexts = n.contexts || {}, n.contexts.trace = this.B), this.$(n),
                    n.breadcrumbs = o(n.breadcrumbs || [], this.N), n.breadcrumbs = n.breadcrumbs.length > 0 ?
                    n.breadcrumbs : void 0, this.F(o(rn(), this.C), n, t)
            }, n
        }();

    function rn() {
        var n = x();
        return n.__SENTRY__ = n.__SENTRY__ || {}, n.__SENTRY__.globalEventProcessors = n.__SENTRY__.globalEventProcessors ||
    ...
    function hn(n) {
        return n && n.__SENTRY__ && n.__SENTRY__.hub ? n.__SENTRY__.hub : (n.__SENTRY__ = n.__SENTRY__ || {}, n.__SENTRY__
            .hub = new un, n.__SENTRY__.hub)
    }
    ...
    var pn = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/,
        yn = function () {
            ...
            return n.prototype.toString = function (n) {
                ...
                var t = this,
                    ...
                    o = t.port,
                    u = t.projectId;
                return t.protocol + "://" + t.user + (n && i ? ":" + i : "") + "@" + r + (o ? ":" + o : "") +
                    "/" + (e ? e + "/" : e) + u
                ...
                this.protocol = n.protocol, this.user = n.user, this.pass = n.pass || "", this.host = n.host,
                    this.port = n.port || "", this.path = n.path || "", this.projectId = n.projectId
        ...
        mn = function () {
            ...
            return n.prototype.getDsn = function () {
                ...
                return e.push("sentry_timestamp=" + (new Date).getTime()), e.push("sentry_client=" + n + "/" +
                    t), e.push("sentry_key=" + r.user), r.pass && e.push("sentry_secret=" + r.pass), {
                ...
                for (var i in e.push("dsn=" + t.toString()), n)
                    if ("user" === i) {
                        if (!n.user) continue;
                        n.user.name && e.push("name=" + encodeURIComponent(n.user.name)), n.user.email && e.push(
                            "email=" + encodeURIComponent(n.user.email))
    ...
    function bn(n) {
        ...
        return function (n) {
            ...
            t[n.name] = n,
                function (n) {
                    -1 === wn.indexOf(n.name) && (n.setupOnce(en, an), wn.push(n.name), A.log(
                        "Integration installed: " + n.name))
                }(n)
        }), t
    }
    var gn, En = function () {
            function n(n, t) {
                this.rn = {}, this.en = !1, this.in = new n(t), this.on = t, t.dsn && (this.un = new yn(t.dsn)),
            ...
            return n.prototype.captureException = function (n, t, r) {
                ...
                var i = this,
                    o = r && r.event_id;
                return this.en = !0, (p(n) ? this.sn().eventFromMessage("" + n, t, r) : this.sn().eventFromException(
                    n, r)).then(function (n) {
                    return i.an(n, r, e)
                }).then(function (n) {
                ...
                var i = this.getOptions(),
                    ...
                    a = void 0 === s ? 250 : s,
                    f = e({}, n);
                void 0 === f.environment && void 0 !== o && (f.environment = o), void 0 === f.release && void 0 !==
                    u && (f.release = u), void 0 === f.dist && void 0 !== c && (f.dist = c), f.message && (f.message =
                        q(f.message, a));
                ...
                var e = this,
                    ...
                    o = i.beforeSend,
                    u = i.sampleRate;
                return this.cn() ? "number" == typeof u && Math.random() > u ? V.reject(
                    "This event has been sampled, will not send event.") : new V(function (i, u) {
                    e.hn(n, r, t).then(function (n) {
                        if (null !== n) {
                            var r = n;
                            try {
                                if (t && t.data && !0 === t.data.__sentry__ || !o) return e.sn()
        ...
        jn = function () {
            function n(n) {
                this.on = n, this.on.dsn || A.warn("No DSN provided, backend will not do anything."), this.dn =
                    this.pn()
            }
        ...
        On = function () {
            ...
            return n.prototype.setupOnce = function () {
                ...
                return this.wn(n, t) ? (A.warn("Event dropped due to being internal Sentry Error.\nEvent: " + S(
                        n)), !0) : this.bn(n, t) ? (A.warn(
                        "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + S(n)), !0) :
                    this.gn(n, t) ? (A.warn(
                        "Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + S(n) +
                        ".\nUrl: " + this.En(n)), !0) : !this.xn(n, t) && (A.warn(
                ...
                return void 0 === t && (t = {}), !(!t.ignoreErrors || !t.ignoreErrors.length) && this.jn(n).some(
                    function (n) {
    ...
    function Mn(n) {
        ...
        try {
            if (t = function (n) {
                    ...
                    for (var t, r = n.stacktrace, e = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i,
                            i =
            ...
            if (t = function (n) {
                    ...
                    for (var t, r, e, i = [], o = n.stack.split("\n"), u = 0; u < o.length; ++u) {
                        if (r = Rn.exec(o[u])) {
                            ...
                            r[2] && 0 === r[2].indexOf("eval") && (t = Nn.exec(r[2])) && (r[2] = t[1], r[3] = t[2],
                                r[4] = t[3]), e = {
                                url: r[2],
                                func: r[1] || Tn,
                                args: c ? [r[2]] : [],
                            ...
                            r[3] && r[3].indexOf(" > eval") > -1 && (t = Cn.exec(r[3])) ? (r[1] = r[1] || "eval", r[
                                    3] = t[1], r[4] = t[2], r[5] = "") : 0 !== u || r[5] || void 0 === n.columnNumber ||
                                (i[0].column = n.columnNumber + 1), e = {
                                    url: r[3],
                                    func: r[1] || Tn,
                                    args: r[2] ? r[2].split(",") : [],
                                    line: r[4] ? +r[4] : null,
    ...
    function Hn(n) {
        ...
        var t = n,
            r = t[0].func || "",
            e = t[t.length - 1].func || "";
        return -1 === r.indexOf("captureMessage") && -1 === r.indexOf("captureException") || (t = t.slice(1)), -1 !==
            e.indexOf("sentryWrapped") && (t = t.slice(0, -1)), t.map(function (n) {
                return {
            ...
            var e = {
                exception: {
                    values: [{
                        ...
                        value: "Non-Error " + (r ? "promise rejection" : "exception") +
                            " captured with keys: " + z(n)
                    }]
                },
                extra: {
                    __serialized__: $(n)
                    ...
                    if (this.cn()) {
                        ...
                        if (n.eventId)
                            if (r) {
                                ...
                                e.async = !0, e.src = new mn(r).getReportDialogEndpoint(n), n.onLoad && (e.onload =
                                    n.onLoad), (t.head || t.body).appendChild(e)
    ...
    function rt(n, t, r) {
            ...
            try {
                ...
                throw nt += 1, setTimeout(function () {
                    ...
                    r.addEventProcessor(function (n) {
                        var r = e({}, n);
                        return t.mechanism && (k(r, void 0, void 0), T(r, t.mechanism)), r.extra =
                            e({}, r.extra, {
                                arguments: J(i, 3)
                            }), r
                    }), captureException(n)
        ...
        n.prototype = n.prototype || {}, sentryWrapped.prototype = n.prototype, Object.defineProperty(n,
            "__sentry_wrapped__", {
                enumerable: !1,
                value: sentryWrapped
        ...
        try {
            Object.getOwnPropertyDescriptor(sentryWrapped, "name").configurable && Object.defineProperty(
                sentryWrapped, "name", {
                    get: function () {
                        return n.name
                    }
    ...
    function ot() {
        return function (n) {
            ...
            var r = t && t.tagName;
            r && ("INPUT" === r || "TEXTAREA" === r || t.isContentEditable) && (Bn || it("input")(n),
    ...
    var ut = function () {
            function t(n) {
                this.name = t.id, this._n = x(), this.Sn = null, this.On = null, this.kn = !1, this.Tn = !1, this.on =
                    e({
                        onerror: !0,
            ...
            return t.prototype.setupOnce = function () {
                Error.stackTraceLimit = 50, this.on.onerror && (A.log("Global Handler attached: onerror"), this
                    .Rn()), this.on.onunhandledrejection && (A.log(
                    "Global Handler attached: onunhandledrejection"), this.Dn())
                ...
                return n.exception = n.exception || {}, n.exception.values = n.exception.values || [], n.exception
                    .values[0] = n.exception.values[0] || {}, n.exception.values[0].stacktrace = n.exception.values[
                        0].stacktrace || {}, n.exception.values[0].stacktrace.frames = n.exception.values[0].stacktrace
                    .frames || [], 0 === n.exception.values[0].stacktrace.frames.length && n.exception.values[0]
        ...
        ct = function () {
            ...
            return n.prototype.Un = function (n) {
                ...
                var t = x(),
                    r = t[n] && t[n].prototype;
                r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (P(r, "addEventListener",
                    function (t) {
                        return function (r, e, i) {
                            try {
                                "function" == typeof e.handleEvent && (e.handleEvent = rt(e.handleEvent
                                    .bind(e), {
                                        mechanism: {
                                            data: {
                ...
                this.Mn = this.Mn;
                var n = x();
                P(n, "setTimeout", this.Un.bind(this)), P(n, "setInterval", this.Un.bind(this)), P(n,
                    "requestAnimationFrame", this.An.bind(this)), ["EventTarget", "Window", "Node",
                    "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation",
                    "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest",
                    "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow",
                    "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue",
                    "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest",
                    "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(this.Ln.bind(this))
            }, n.id = "TryCatch", n
        }();
            ...
            return t.prototype.qn = function () {
                "console" in ft && ["debug", "info", "warn", "error", "log", "assert"].forEach(function (r) {
                    r in ft.console && P(ft.console, r, function (e) {
                        return function () {
                            for (var i = [], o = 0; o < arguments.length; o++) i[o] =
                                arguments[o];
                            var u = {
                                category: "console",
                                data: {
                            ...
                            "assert" === r ? !1 === i[0] && (u.message =
                                "Assertion failed: " + (F(i.slice(1), " ") ||
                                    "console.assert"), u.data.extra.arguments = J(i.slice(
                                    1), 3), t.addBreadcrumb(u, {
                                    input: i,
                                    level: r
                                })) : t.addBreadcrumb(u, {
                                input: i,
                ...
                "document" in ft && (ft.document.addEventListener("click", it("click"), !1), ft.document.addEventListener(
                    "keypress", ot(), !1), ["EventTarget", "Node"].forEach(function (n) {
                    var t = ft[n] && ft[n].prototype;
                    t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (P(t,
                        "addEventListener",
                        function (n) {
                            return function (t, r, e) {
                                return r && r.handleEvent ? ("click" === t && P(r,
                                    "handleEvent",
                                    function (n) {
                                        return function (t) {
                                            return it("click")(t), n.call(
                                                this, t)
                                        }
                                    }), "keypress" === t && P(r, "handleEvent",
                                    function (n) {
                                        return function (t) {
                                            return ot()(t), n.call(this, t)
                                        }
                                    })) : ("click" === t && it("click", !0)(this),
                                    "keypress" === t && ot()(this)), n.call(this, t,
                                    r, e)
                            }
                ...
                (function () {
                    ...
                    if (e) {
                        ...
                        i.hidden = !0;
                        try {
                            e.head.appendChild(i), i.contentWindow && i.contentWindow.fetch && (r = n(i.contentWindow
                                .fetch)), e.head.removeChild(i)
                        } catch (n) {
                            A.warn(
                    ...
                    return function () {
                        ...
                        var o, u = e[0],
                            c = "GET";
                        "string" == typeof u ? o = u : "Request" in ft && u instanceof Request ? (o =
                                u.url, u.method && (c = u.method)) : o = String(u), e[1] && e[1].method &&
                            (c = e[1].method);
                        var s = an().getClient(),
                            a = s && s.getDsn();
                        if (a) {
                            var f = new mn(a).getStoreEndpoint();
                            if (f && -1 !== o.indexOf(f)) return "POST" === c && e[1] && e[1].body &&
                                vt(e[1].body), r.apply(ft, e)
                        }
                        var h = {
                ...
                var n = this;
                if (r = x(), e = r.chrome, i = e && e.app && e.app.runtime, o = "history" in r && !!r.history.pushState &&
                    !!r.history.replaceState, !i && o) {
                    var r, e, i, o, u = function (n, r) {
                            var e = _(ft.location.href),
                                i = _(r),
                                o = _(n);
                            o.path || (o = e), at = r, e.protocol === i.protocol && e.host === i.host && (r = i
                                    .relative), e.protocol === o.protocol && e.host === o.host && (n = o.relative),
                                t.addBreadcrumb({
                                    category: "navigation",
                                    data: {
                                        from: n,
                    ...
                    P(n, "open", function (n) {
                        return function () {
                            ...
                            if (o) {
                                ...
                                d(e) && u && -1 !== e.indexOf(u) && (this.__sentry_own_request__ = !
                                    0)
                            }
                        ...
                        return function () {
                            ...
                            return ["onload", "onerror", "onprogress"].forEach(function (n) {
                                    ! function (n, t) {
                                        n in t && "function" == typeof t[n] && P(t, n, function (
                                            t) {
                                            return rt(t, {
                                                mechanism: {
                                                    data: {
                ...
                this.on.console && this.qn(), this.on.dom && this.Fn(), this.on.xhr && this.Wn(), this.on.fetch &&
                    this.Hn(), this.on.history && this.Pn()
            }, t.id = "Breadcrumbs", t
        }();
            ...
            return n.prototype.setupOnce = function () {
                en(function (t) {
                    if (an().getIntegration(n)) {
                        ...
                        var r = t.request || {};
                        return r.url = r.url || yt.location.href, r.headers = r.headers || {}, r.headers[
                            "User-Agent"] = yt.navigator.userAgent, e({}, t, {
                            request: r
                        })
                    }
                    return t
    ...
    var xt = e({}, gt, kn, wt);
    return n.BrowserClient = Yn, n.Hub = un, n.Integrations = xt, n.SDK_NAME = Qn, n.SDK_VERSION = "5.7.1", n.Scope =
        tn, n.Span = nn, n.Transports = Vn, n.addBreadcrumb = function (n) {
            ln("addBreadcrumb", n)
            ...
            if (void 0 === n && (n = {}), void 0 === n.defaultIntegrations && (n.defaultIntegrations = bt), void 0 ===
                n.release) {
                var t = x();
